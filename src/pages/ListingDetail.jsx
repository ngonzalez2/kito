    ...
    return (
      <PageTransition>
        <section className="flex min-h-[60vh] flex-col items-center justify-center gap-6">
          <p className="text-lg text-deep-blue/70">Listing not found.</p>
          <button
            type="button"
        ...
        <div className="mx-auto flex max-w-5xl flex-col gap-12 px-4 sm:px-6">
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="flex flex-col gap-6">
              <div>
                <span className="text-xs font-semibold uppercase tracking-[0.4em] text-coral">{listing.condition}</span>
              ...
              <div className="grid gap-2 text-sm text-deep-blue/80">
                <span>Ubicación: {listing.location}</span>
                <span>Marca: {listing.brand || 'Duotone'}</span>
              </div>
              <p className="text-sm text-deep-blue/70">
                Perfecto para sesiones entre 18 y 28 nudos. Reemplazo de válvulas y revisión de costuras en 2023.
                Listo para entregar en la costa Caribe o enviar a cualquier ciudad.
              </p>
              <a
          ...
          <div className="space-y-6">
            <h2 className="font-heading text-2xl uppercase tracking-[0.3em] text-deep-blue">Similar Listings</h2>
